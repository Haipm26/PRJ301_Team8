<%-- 
    Document   : updateLaptop
    Created on : Mar 3, 2026, 10:51:46 AM
...
<html>
    ...
    <body>
    <form action="${pageContext.request.contextPath}/laptops/update" method="post" enctype="multipart/form-data">
        
        <input type="hidden" name="id" value="${laptop.id}">

        Name : <input type="text" name="name" value="${laptop.name}"><br/>
        Brand : <input type="text" name="brand" value="${laptop.brand}"><br/>
        Price : <input type="text" name="price" value="${laptop.price}"><br/>
        ...
        Description : <textarea name="description" rows="10" cols="10">${laptop.description}</textarea><br/>
        
        Featured : 
        <input type="radio" name="isFeatured" value="true" ${laptop.isFeatured ? 'checked' : ''}> TRUE 
        <input type="radio" name="isFeatured" value="false" ${laptop.isFeatured ? '' : 'checked'}> FALSE<br/>
        
        New Arrival : 
        <input type="radio" name="isNewArrival" value="true" ${laptop.isNewArrival ? 'checked' : ''}> TRUE 
        <input type="radio" name="isNewArrival" value="false" ${laptop.isNewArrival ? '' : 'checked'}> FALSE<br/>
