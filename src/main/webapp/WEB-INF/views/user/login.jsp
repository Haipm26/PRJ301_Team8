<%@page contentType="text/html" pageEncoding="UTF-8" %>
    <%@ taglib prefix="c" uri="jakarta.tags.core" %>
        ...
        <head>
            ...
            <title>Login - Octatech LaptopShop</title>
                ...
                <div class="col-md-6 col-lg-5">
                    <div class="card auth-card">
                        <div class="auth-header">
                            <h2>Welcome Back</h2>
                            <p class="mb-0 text-white-50">Log in to your account</p>
                        </div>
                        <div class="auth-body">
                            ...
                            <form action="${pageContext.request.contextPath}/login" method="post">
                                <div class="mb-4">
                                    <label for="username" class="form-label fw-bold text-secondary text-uppercase"
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control border-start-0 ps-0" id="username"
                                            name="username" value="${prefilledUsername}"
                                            placeholder="Enter your username" required>
                                    </div>
                                </div>

                                <div class="mb-4">
                                    <label for="password" class="form-label fw-bold text-secondary text-uppercase"
                                ...
                                <button type="submit" class="btn btn-primary btn-auth w-100 mb-4 shadow"><i
                                        class="bi bi-box-arrow-in-right me-2"></i> Login to Account</button>

                                <div class="text-center text-muted">
                                    Don't have an account? <a href="${pageContext.request.contextPath}/register"
                                        class="fw-bold text-decoration-none">Sign up here</a>
                                </div>
                            </form>
                        </div>
                    </div>
