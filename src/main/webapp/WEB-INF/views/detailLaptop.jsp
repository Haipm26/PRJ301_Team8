                    ...
                    <div class="row align-items-center g-5">
                        ...
                        <div class="col-lg-6">
                            ...
                            <ul class="specs-list mb-5">
                                <li><i class="bi bi-cpu"></i> <strong>Processor</strong> <span>${laptop.cpu}</span></li>
                                <li><i class="bi bi-memory"></i> <strong>RAM</strong> <span>${laptop.ram}</span></li>
                                <li><i class="bi bi-device-hdd"></i> <strong>Storage</strong>
                                    <span>${laptop.storage}</span>
                                </li>
                                <li><i class="bi bi-palette"></i> <strong>Color</strong> <span>${laptop.color}</span>
                                </li>
                            </ul>
                            ...
                            <div class="col">
                                <div class="card h-100 shadow-sm border-0" style="border-radius:15px; overflow:hidden;">
                                    ...
                                    <div class="card-body d-flex flex-column">
                                        ...
                                        <div class="text-info fw-bold mb-3">$${sl.price}</div>
